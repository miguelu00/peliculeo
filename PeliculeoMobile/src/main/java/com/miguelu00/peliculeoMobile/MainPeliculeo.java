...
import com.miguelu00.peliculeoMobile.adapters.PeliculaAdapter;
import com.miguelu00.peliculeoMobile.models.Pelicula;
import com.miguelu00.peliculeoMobile.servicioAPI.PeliculaAPIServicio;
...
public class MainPeliculeo extends AppCompatActivity {
    ...
    private void getAllPeliculas() {
        Retrofit retrofit = ClienteRetrofit.getClient("https://api.tuservidor.com/");
