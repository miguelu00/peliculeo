...
/**
 * Para mas info de la API de Peliculeo! eche un vistazo
 * en la documentación de GitHub sobre la API: 
 * @author Miguelañez-PC
 */
public class PeliculasAPIUtils implements CFG_APP {
    private static final String URL_BASE = "http://" + API_HOST + ":" + PUERTO_HOST + "/api/peliculas/";
